...
cat <<-EON | sudo tee /var/www/html/index.html
<!DOCTYPE html>
<html>
<head>
...
<h2>InstanceID: $(curl -H "X-aws-ec2-metadata-token: $TOKEN" -s http://169.254.169.254/latest/meta-data/instance-id)</h2>
</body>
</html>
EON
